...
\textbf{5\% stratified sample ($\approx$1.7M loans)} drawn proportionally by vintage year.
...
\end{equation}
14 features: 10 numeric (credit score, LTV, DTI, UPB, origination-era macro, rate incentive,
max delinquency, ever 90+ DQ) $+$ 4 one-hot (loan purpose $\times$ 2, occupancy $\times$ 2);
$\ell_2$ penalizer $= 0.1$.
