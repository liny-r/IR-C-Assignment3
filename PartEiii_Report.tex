...
\begin{figure}[h]
    ...
    \caption{Mean $|\partial\text{CIF}_1/\partial\mathbf{x}|$ at month 60, resolved by loan age.
      ...
      \texttt{rate\_incentive} is most influential in early months (origination-era incentive),
      then \texttt{ELTV} rises as equity accumulates and gates the refi option.
