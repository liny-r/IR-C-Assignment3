...
\author{R. Lin, P. Smalhout, D. Tuzes}
\institute{IR and Credit}
\date{May 13, 2026}
...
% ============================================================ Slide 4: Pipeline architecture removed
...
\begin{frame}{Part A --- Kaplan--Meier on the Full Population}
    ...
    \begin{center}
        \includegraphics[width=0.55\linewidth]{plots/A_km_overall.pdf}
    \end{center}
...
\begin{frame}{Part A --- Hazards}
    ...
    \begin{center}
        \includegraphics[width=0.85\linewidth]{plots/A_hazard_overall.pdf}
    \end{center}
...
\begin{frame}{Part A --- Stratification by Vintage and FICO}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/A_km_by_vintage.pdf}
        \end{center}
        \small
        ...
        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/A_km_by_fico.pdf}
        \end{center}
        \small
...
\begin{frame}{Part B --- Cox PH with Origination Covariates}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{itemize}\itemsep1pt
            ...
            \item \textbf{Original Unpaid Principal Balance}: $1.29$
        ...
        \vspace{-2em}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/B_hazard_ratios_base.pdf}
        \end{center}
...
\begin{frame}{Part B --- Vintage-Macro Extension}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{itemize}\itemsep1pt
            ...
            \item house pricing index (seasonally adjusted): $0.89$
            \item Unemployment: $0.89$
            \item market average 30y mortgage rate: $0.94$
        \end{itemize}
        ...
        \vspace{-1.5em}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/B_hazard_ratios_macro.pdf}
        \end{center}
    \end{columns}
...
\begin{frame}{Part B --- Proportional Hazards Diagnostic}
    ...
    \vspace{-1em}
    \begin{center}
        \includegraphics[width=0.85\linewidth]{plots/B_loglog_curves.pdf}
    \end{center}
    \vspace{-2em}
    \begin{columns}[T,onlytextwidth]
        \column{0.5\textwidth}
        ...
        \begin{itemize}\itemsep2pt
            \item Kaplan--Meier survival $S(t)$ for time to prepayment stratified by FICO, LTV, and purpose
            \item Plotted $\log[-\log S(t)]$ against $\log(t+1)$. Under prop haz., curves should be parallel.
        \end{itemize}

        \column{0.5\textwidth}

        \begin{itemize}\itemsep2pt
            \item gaps are not constant over loan age; several strata bend and converge/diverge over time
            \item prepayment covariate effects are time-varying, motivating age interactions and ML/deep models
        \end{itemize}
...
% ============================================================ Slide 12: Part C score distributions & feature importance
\begin{frame}{Part C --- Score Distributions and Feature Importance}

    \begin{center}
        \includegraphics[width=0.9\linewidth]{plots/C_feature_importance_T12.pdf}
    \end{center}
    The feature-importance plot reports the top 15 predictors for each ML model at the T=12 horizon.
...
\begin{frame}{Part C --- Score Distributions and Feature Importance}
    ...
    \begin{center}
        \includegraphics[width=0.8\linewidth]{plots/C_score_distributions.pdf}
    \end{center}
    The score-distribution plot shows predicted prepayment probabilities for T=12 and T=60, separated by model and realized prepayment status.
...
\begin{frame}{Part C --- Out-of-Sample AUC}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{center}
            \includegraphics[width=\linewidth]{plots/C_auc_by_horizon.pdf}
        \end{center}
...
\begin{frame}{Part C --- Calibration and Top-Decile Lift}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/C_calibration.pdf}
        \end{center}
        \textbf{Calibration} is reasonable for all models

        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/C_top_decile_lift.pdf}
        \end{center}
...
\begin{frame}{Part D --- Linear vs Deep Ablation (D(v))}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.55\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/D_ablation_bars.pdf}
        \end{center}
...
\begin{frame}{Part D --- Head-to-Head with All Models}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.55\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/D_auc_by_horizon.pdf}
        \end{center}
...
% ============================================================ Slide 17: Part D AUC by vintage
\begin{frame}{Part D --- AUC by Vintage}

    \begin{center}
        \includegraphics[width=\linewidth]{plots/D_auc_by_vintage.pdf}
    \end{center}
...
\begin{frame}{Part D --- Calibration and Top-Decile Lift}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/D_calibration.pdf}
        \end{center}
        \textbf{Calibration.} DeepCox sits close to the diagonal at all horizons. LinearCox slightly under-confident.

        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{plots/D_top_decile_lift.pdf}
        \end{center}
