...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{plots/A_km_overall.pdf}
  \includegraphics[width=0.9\textwidth]{plots/A_hazard_overall.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\textwidth]{plots/A_km_by_vintage.pdf}\hfill
  \includegraphics[width=0.49\textwidth]{plots/A_km_by_fico.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\textwidth]{plots/A_km_by_ltv.pdf}\hfill
  \includegraphics[width=0.49\textwidth]{plots/A_km_by_purpose.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\textwidth]{plots/B_hazard_ratios_macro.pdf}\hfill
  \includegraphics[width=0.49\textwidth]{plots/B_ph_test.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\textwidth]{plots/C_auc_by_horizon.pdf}\hfill
  \includegraphics[width=0.49\textwidth]{plots/C_calibration.pdf}
  \caption{\textbf{Part C.} Left: AUC by model and horizon. Right: decile calibration plot.}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.65\textwidth]{plots/C_top_decile_lift.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.48\textwidth]{plots/D_ablation_bars.pdf}\hfill
  \includegraphics[width=0.48\textwidth]{plots/D_auc_by_horizon.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\textwidth]{plots/D_calibration.pdf}\hfill
  \includegraphics[width=0.49\textwidth]{plots/D_top_decile_lift.pdf}
