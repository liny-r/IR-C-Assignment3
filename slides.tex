...
% Show current section in bottom-centre footer
...
\begin{frame}{Part A --- Kaplan--Meier on the Full Population}
    ...
    \begin{center}
        \includegraphics[width=0.55\linewidth]{figures/A_km_overall.pdf}
    \end{center}
...
\begin{frame}{Part A --- Hazards}
    ...
    \begin{center}
        \includegraphics[width=0.85\linewidth]{figures/A_hazard_overall.pdf}
    \end{center}
...
\begin{frame}{Part A --- Stratification by Vintage and FICO}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/A_km_by_vintage.pdf}
        \end{center}
        \small
        ...
        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/A_km_by_fico.pdf}
        \end{center}
        \small
...
\begin{frame}{Part B --- Cox PH with Origination Covariates}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \vspace{-2em}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/B_hazard_ratios_base.pdf}
        \end{center}
...
\begin{frame}{Part B --- Vintage-Macro Extension}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \vspace{-1.5em}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/B_hazard_ratios_macro.pdf}
        \end{center}
    \end{columns}
...
\begin{frame}{Part B --- Proportional Hazards Diagnostic}
    ...
    \vspace{-1em}
    \begin{center}
        \includegraphics[width=0.85\linewidth]{figures/B_loglog_curves.pdf}
    \end{center}
    \vspace{-2em}
    \begin{columns}[T,onlytextwidth]
        \column{0.5\textwidth}
...
\begin{frame}{Part C --- Feature Importance (T=12)}
    ...
    \begin{center}
        \includegraphics[width=0.9\linewidth]{figures/C_feature_importance_T12.pdf}
    \end{center}
...
\begin{frame}{Part C --- Score Distributions}
    ...
    \begin{center}
        \includegraphics[width=0.8\linewidth]{figures/C_score_distributions.pdf}
    \end{center}
...
\begin{frame}{Part C --- Out-of-Sample AUC}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{center}
            \includegraphics[width=\linewidth]{figures/C_auc_by_horizon.pdf}
        \end{center}
...
\begin{frame}{Part C --- Calibration and Top-Decile Lift}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/C_calibration.pdf}
        \end{center}
        \textbf{Calibration} is reasonable for all models.

        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/C_top_decile_lift.pdf}
        \end{center}
...
\begin{frame}{Part D --- Linear vs Deep Ablation (D(v))}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.55\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/D_ablation_bars.pdf}
        \end{center}
...
\begin{frame}{Part D --- Head-to-Head with All Models}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.55\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/D_auc_by_horizon.pdf}
        \end{center}
...
\begin{frame}{Part D --- AUC by Vintage}
    ...
    \begin{center}
        \includegraphics[width=\linewidth]{figures/D_auc_by_vintage.pdf}
    \end{center}
...
\begin{frame}{Part D --- Calibration and Top-Decile Lift}
    ...
    \begin{columns}[T,onlytextwidth]
        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/D_calibration.pdf}
        \end{center}
        \textbf{Calibration.} DeepCox close to diagonal at all horizons. LinearCox slightly under-confident.

        \column{0.5\textwidth}
        \begin{center}
            \includegraphics[width=\linewidth]{figures/D_top_decile_lift.pdf}
        \end{center}
...
\begin{frame}{Appendix: Sampling Summary by Part}
    \small
    \begin{tabular}{p{1.0cm}p{3.2cm}p{3.2cm}p{5.0cm}}
        \toprule
        \textbf{Part} & \textbf{Sample} & \textbf{Train / Test} & \textbf{Notes} \\
        \midrule
        A
          & Full 31.7M loans
          & N/A
          & No sampling; KM fit on entire population \\[4pt]
        B
          & 5\% $\approx$ 1.58M loans
          & Vintage split ($\leq$2014 / 2015--2019)
          & 1.08M events; PH diagnostic on 158K subsample \\[4pt]
        C
          & 10\% $\approx$ 2.45M loans
          & 1.85M train / 597K test
          & 68 one-hot features; same canonical split as D \\[4pt]
        D
          & Same 10\% as C
          & 1.66M inner train / 185K val / 597K test
          & Extra 10\% val carve for early stopping \\[4pt]
        E(i)
          & Full survival table
          & Same vintage split
          & Competing-risk labels: prepay=1, default=2, censored=0 \\[4pt]
        E(ii)
          & 100K panel loans
          & Same vintage split
          & ${\sim}47$ mo avg $= 4.68$M loan-month intervals \\[4pt]
        E(iii)
          & 101K panel loans
          & 80K train / 21K test (stratified)
          & 60K prepay + 31K default + 35K censored; drawn from 2M panel loans with monthly history; 4.5M rows \\[4pt]
        E(iv)
          & Same as E(ii)
          & Same as E(ii)
          & TV Cox model re-used; 200-path Monte Carlo for MBS pricing \\
        \bottomrule
    \end{tabular}
\end{frame}
